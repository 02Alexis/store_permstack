  ...
  if (error) {
    return (
      <div role="alert" className="alert alert-error">
        <span>Algo salió mal. Por favor actualice la página.</span>
      </div>
    );
  }
  return (
        ...
        <div className="hero-content flex-col lg:flex-row-reverse gap-10 py-10">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
              Comparte tus <span className="text-primary">Productos</span>
            </h1>
            <p className="py-4 text-base-content/60">
              Sube, descubre y conecta con creadores.
            </p>
        ...
        {products.length === 0 ? (
          <div className="card bg-base-300">
            <div className="card-body items-center text-center py-16">
              ...
              <h3 className="card-title text-base-content/50">Aún no hay productos</h3>
              <p className="text-base-content/40 text-sm">Sea el primero en compartir algo!</p>
