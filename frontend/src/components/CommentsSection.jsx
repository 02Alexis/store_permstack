    ...
    <div className="space-y-4">
      ...
      {isSignedIn ? (
        ...
        <div className="flex items-center justify-between bg-base-200 rounded-lg p-3">
          <span className="text-sm text-base-content/60">Inicia sesión para unirte a la conversación</span>
            ...
            <div key={comment.id} className="chat chat-start">
              ...
              {currentUserId === comment.userId && (
                <div className="chat-footer">
                  <button
                    onClick={() =>
                      confirm("Eliminar comentario?") && deleteComment.mutate({ commentId: comment.id })
                    }
